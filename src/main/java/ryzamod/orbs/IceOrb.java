...
import ryzamod.cards.common.IceBomb;
import ryzamod.util.TextureLoader;

import static ryzamod.RyzaMod.orbPath;

public class IceOrb extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = RyzaMod.makeID("FireOrb");
    ...
    public IceOrb() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], orbPath("ice_orb.png"));
    ...
    public IceOrb(String ID, String NAME, int basePassiveAmount, int baseEvokeAmount, String passiveDescription, String evokeDescription, String imgPath) {
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        AbstractDungeon.actionManager.addToBottom( // 2.Damage all enemies
                new MakeTempCardInHandAction(new IceBomb()));
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(50.0f, 230.0f, 230.0f, c.a / 2.0f));

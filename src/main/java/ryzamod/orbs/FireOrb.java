...
public class FireOrb extends CustomOrb {
    ...
    public FireOrb() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], orbPath("fire_orb.png"));
    ...
    public FireOrb(String ID, String NAME, int basePassiveAmount, int baseEvokeAmount, String passiveDescription, String evokeDescription, String imgPath) {
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        AbstractDungeon.actionManager.addToBottom( // 2.Damage all enemies
                new MakeTempCardInHandAction(new ExplosiveUni()));
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(220.0f, 90.0f, 30.0f, c.a / 2.0f));
